...
CONTAINS
   ...
   SUBROUTINE alloc_space_field_core_5 ( grid,   id, setinitval_in ,  tl_in , inter_domain_in , num_bytes_allocated , &
...
ELSE
  ...
  if (ierr.ne.0) then
    CALL wrf_error_fatal3("<stdin>",2867,&
...
((((em31)-(sm31)+1))*(((em32)-(sm32)+1))*(((em33)-(sm33)+1))) * 4
  ...
  if (ierr.ne.0) then
    CALL wrf_error_fatal3("<stdin>",3348,&
...
ELSE
  ...
  if (ierr.ne.0) then
    CALL wrf_error_fatal3("<stdin>",3516,&
