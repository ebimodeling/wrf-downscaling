...
subroutine ext_c2n_fulldom  (II,JJ,W1,W2,W3,W4,&
  ...
  use module_interp_store, only: parent_fis, nest_fis
  use module_interp_nmm, only: c2n_fulldom
  implicit none
  integer, intent(in):: cims, cime, cjms, cjme, ckms, ckme,   &
       nids, nide, njds, njde, nkds, nkde,   &
       nims, nime, njms, njme, nkms, nkme,   &
...
subroutine ext_n2c_fulldom  ( &
  ...
  use module_interp_store, only: parent_fis, nest_fis
  use module_interp_nmm, only: n2c_fulldom
  implicit none
  integer, intent(in):: cims, cime, cjms, cjme, ckms, ckme,   &
       cids, cide, cjds, cjde, ckds, ckde,   &
       cits, cite, cjts, cjte, ckts, ckte,   &
...
subroutine ext_c2b_fulldom  (II,JJ,W1,W2,W3,W4,&
     ...
     tbxs,    tbxe,    tbys,    tbye,      &
     qbxs,    qbxe,    qbys,    qbye)
  use module_interp_nmm, only: c2b_fulldom 
  use module_interp_store, only: parent_fis, nest_fis
  implicit none
  integer, intent(in):: &
       cims, cime, cjms, cjme, ckms, ckme,   &
  ...
  call c2b_fulldom  (II,JJ,W1,W2,W3,W4,&
       deta1,deta2, eta1,eta2, ptop,pdtop,   &
