...
20    end do
      ...
      subroutine qfts ( nv, nv1, ib,as,u0,f0,ww1,ww2,ww3,ww4,ww,tt,ffu,ffd )
...
12    end do
      ...
      h=xa(khi)-xa(klo)
      if (h.eq.0.)  CALL wrf_error_fatal3("<stdin>",14590,&
...
11    end do
      ...
      do m=1,n-1
        do i=1,n-m
          ...
          w=c(i+1)-d(i)
          den=ho-hp
          if(den.eq.0.)  CALL wrf_error_fatal3("<stdin>",14626,&
...
13    end do
     ...
     &             (10 ** (-3.49149 * (tsot - 1)) - 1)
      ...
      if (n_atau<0 .or.n_atau>mxat) CALL wrf_error_fatal3("<stdin>",14811,&
'errro in Aerosol Tau / Wavelengths. STOP program')  
      if (ifg < 0 .or. ifg > 8) CALL wrf_error_fatal3("<stdin>",14813,&
'Error in ifg: Aerosol RH% Flag. STOP program')  
      ...
      if (itps(iac).eq.1) then
        ...
        itp = iac
        if ( itp < 1 .or. itp > naer ) CALL wrf_error_fatal3("<stdin>",14823,&
...
'ivd : Aerosol Profile flag. STOP program')  
        ...
        case (1:2)   
          ...
          if(sump.eq.0.) CALL wrf_error_fatal3("<stdin>",14972,&
