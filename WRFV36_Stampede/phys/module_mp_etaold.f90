...
nsteps = 0
     ...
     & RHLIMIT1=-RHLIMIT
      ...
      SUBROUTINE ETAOLDinit (GSMDT,DT,DELX,DELY,LOWLYR,restart,         &
     &   F_ICE_PHY,F_RAIN_PHY,F_RIMEF_PHY,                              &
     &   MP_RESTART_STATE,TBPVS_STATE,TBPVS0_STATE,                     &
     &   ALLOWED_TO_READ,                                               &
     &   IDS,IDE,JDS,JDE,KDS,KDE,                                       &
...
'module_mp_etaold: ETAOLDinit: Can not find '// &
...
9061 CONTINUE
      WRITE( errmess , '(A,I4)' )                                        &
       'module_mp_etaold: error opening ETAMPNEW_DATA on unit '          &
     &, etampnew_unit1
      CALL wrf_error_fatal3("<stdin>",2352,&
errmess)


      END SUBROUTINE ETAOLDinit
